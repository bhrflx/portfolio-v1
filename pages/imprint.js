...
export default function Imprint() {
    ...
    return (
        <>
            <NextSeo {...SEO}/>
            <section className="w-full text-gray-800 px-5 py-10 flex flex-col items-center">
                <div className="w-2/3 lg:w-5/6 sm:w-[90vw]">
                    <h1 className="text-2xl font-bold mb-3">Imprint</h1>
                    ...
                    <p className="mb-3">
                        ...
                        Seiten oder das gesamte Angebot ohne gesonderte Ankündigung zu verändern, 
                        zu ergänzen, zu löschen oder die Veröffentlichung zeitweise oder endgültig 
                        einzustellen.
                    </p>
                    <h3 className="text-xl font-bold">Verweise und Links</h3>
                    <p className="mb-3">
                    ...
                    <h3 className="text-xl font-bold">Urheber- und Kennzeichenrecht</h3>
                    <p className="mb-3">
                    ...
                    <h4 className="font-bold">Allgemeiner Hinweis und Pflichtinformationen</h4>
                    <p className="mb-3">
                        ...
                        an Dritte weitergegeben. Wir weisen darauf hin, dass die Datenübertragung im Internet 
                    ...
                    <h4 className="mb-3 font-bold">Benennung der verantwortlichen Stelle</h4>
                    <p className="mb-3">
                    Die verantwortliche Stelle für die Datenverarbeitung auf dieser Website ist:<br/>
                    Felix Bahr<br/>
                    Sankt-Johann-Gasse 7<br/>
                    78462 Konstanz<br/>
                    </p>
                    ...
                    <p className="mb-3">
                        ...
                        Google wird in keinem Fall Ihre IP-Adresse mit anderen Daten der Google in Verbindung 
                        bringen. Sie können die Installation der Cookies durch eine entsprechende Einstellung 
                    ...
                    <h3 className="text-xl font-bold">Rechtswirksamkeit dieses Haftungsausschlusses</h3>
                    <p className="mb-3">
